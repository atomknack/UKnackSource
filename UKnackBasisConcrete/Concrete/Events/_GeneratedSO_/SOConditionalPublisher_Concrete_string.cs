...
namespace UKnack.Concrete.Events
{
    ...
    [CreateAssetMenu(fileName = "ConditionalPublisherToSOEvent_string ", menuName = "UKnack/ConditionalPublishers/To string")]
    internal sealed class SOConditionalPublisher_Concrete_string : SOPublisher_Concrete_string
    {
